...
const getGames = async () => {
  ...
  return [
    ...mapGames(specialReserveGamesTexts.firstPageText),
    ...mapGames(specialReserveGamesTexts.secondPageText)
  ]
}
...
const getSpecialReserveGamesResponses = async () => {
  ...
  const secondPageResponse = await fetch(
    'https://specialreservegames.com/games/?sort=featured&page=2&limit=12'
  )
